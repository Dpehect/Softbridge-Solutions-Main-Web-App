...
export const pages: ContentPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Pakistan ve Diğer Yapılardan Ayrışma Beyanı", body: "Softbridge Solutions (Adana, Türkiye & Cascais, Portekiz), Pakistan'ın Rawalpindi şehrinde 1994 yılında kurulmuş olan ve 'softbridge.pk' adresi üzerinden ERP/muhasebe yazılımları sunan 'Soft Bridge' firması ile hiçbir hukuki, yapısal, ticari veya operasyonel bağa sahip değildir. Sitemizde listelenen tüm doğrulanmış ürünlerimiz (Career Forge, KPSS platformları, Velora AI), Upwork veya Fiverr gibi harici serbest çalışan (freelance) ağları üzerinden iş yaptırılarak değil, Yunus Emre Gürlek liderliğindeki kendi çekirdek mühendislik kadromuz tarafından sıfırdan geliştirilmiştir." },
