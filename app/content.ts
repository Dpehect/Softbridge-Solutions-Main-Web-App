...
export const pages: ContentPage[] = [
  ...
  // Company Facts (English)
  {
    ...
    sections: [
      ...
      { title: "Independent Technical References & Technopark R&D", body: "SoftBridge Solutions is a registered technology developer at Çukurova Technopark (Çukurova Üniversitesi Teknoloji Geliştirme Bölgesi), carrying out advanced R&D projects on LangGraph multi-agent supervisors and semantic search (pgvector) indexes. Our projects are officially registered under the Technology Development Zones portal of the Ministry of Industry and Technology. We are active members of the Çukurova Bilişim ve Yazılım Kümelenmesi (ÇUBİK) and cooperate with Çukurova Development Agency (CKA) data baselines. All software claims are verified via open-source repositories and live deployments." },
      ...
      { title: "Information Security & Compliance", body: "SoftBridge Solutions operates in alignment with ISO/IEC 27001:2022 Information Security Management standards. We ensure full compliance with the Turkish Personal Data Protection Law (KVKK No. 6698) and the European Union General Data Protection Regulation (GDPR). Our architectures enforce end-to-end data encryption, strict access controls, and regular vulnerability audits." },
      { title: "Enterprise Delivery Standards", body: "We support our enterprise clients with structured Service Level Agreements (SLAs), dedicated version control workflows, high-availability deployments, and robust database replication across secure geographical zones (Frankfurt, Dublin, and Istanbul)." },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Teknokent Ar-Ge Tescili ve Referanslar", body: "SoftBridge Solutions, Çukurova Teknokent (Çukurova Üniversitesi Teknoloji Geliştirme Bölgesi) bünyesinde tescilli bir Ar-Ge firmasıdır. LangGraph supervisor tabanlı otonom çoklu ajan mimarileri ve pgvector tabanlı kurumsal RAG sistemleri üzerine Sanayi ve Teknoloji Bakanlığı onaylı Ar-Ge projeleri yürütmektedir. Şirketimiz, Çukurova Bilişim ve Yazılım Kümelenmesi (ÇUBİK) üyesidir ve Çukurova Kalkınma Ajansı (ÇKA) veri havuzlarında kayıtlıdır. Tüm iddialarımız, GitHub üzerindeki açık kod depolarımız ve Vercel/Supabase üzerinde koşan canlı uygulamalarımızla bağımsız olarak doğrulanabilir durumdadır." },
      ...
      { title: "Bilgi Güvenliği ve Uyum", body: "SoftBridge Solutions, ISO/IEC 27001:2022 Bilgi Güvenliği Yönetim Sistemi standartlarına uyumlu olarak faaliyet göstermektedir. Kişisel Verilerin Korunması Kanunu (KVKK No. 6698) ve Avrupa Birliği Genel Veri Koruma Yönetmeliği (GDPR) gereklilikleri tam olarak karşılanmaktadır. Sistem mimarilerimizde uçtan uca şifreleme, sıkı erişim kontrolleri ve periyodik sızma testleri uygulanır." },
      { title: "Kurumsal SLA ve Hizmet Standartları", body: "Kurumsal müşterilerimize kararlı Hizmet Seviyesi Anlaşmaları (SLA), sürüm kontrol protokolleri (Git-flow), yüksek erişilebilirlikli sunucu altyapıları ve coğrafi olarak izole edilmiş yedekleme sistemleri (Frankfurt, Dublin ve İstanbul) sunuyoruz." },
