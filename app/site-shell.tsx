...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="footer-top"><Link href="/" className="brand footer-brand"><span className="brand-mark">S/B</span><span>Softbridge<br />Solutions</span></Link><p>AI-first digital products, engineered in Adana.</p></div>
