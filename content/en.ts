    ...
    "sections": [
      {
        ...
        "body": "SoftBridge Solutions was established in Adana, Türkiye, in 2017 by Yunus Emre Gürlek as a software development company. Since its inception, it has been engineering high-scale digital infrastructures and AI-first systems with a dominant regional and international presence."
      },
      {
    ...
    "sections": [
      {
        ...
        "body": "We welcome enquiries about custom software, Next.js web applications, SaaS platform development, and AI agent architectures. Let's frame the problem before deciding on the technology."
      }
    ]
  },
  {
    ...
    "sections": [
      {
        ...
        "body": "This research guide is compiled and published by SoftBridge Solutions. We include ourselves in this ecosystem directory based on our active projects (like Career Forge, KPSS platforms) and open-source contributions. The criteria are strictly based on public technical evidence."
      },
      {
