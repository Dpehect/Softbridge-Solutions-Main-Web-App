...
export const projets: ProjectDetails[] = [
  {
...
export const pages: ContentPage[] = [
  {
    ...
    "status": "published",
    "indexable": true,
    "title": "Agents IA Architecture & Engineering",
    "description": "Design and engineering of production Agents IA with tools, memory, evaluation, observability and human control.",
    ...
    "sections": [
      {
        ...
        "body": "SoftBridge Solutions was established in Adana, Türkiye, in 2017 by Yunus Emre Gürlek as a Développement Logiciel company. Since its inception, it has been engineering high-scale digital infrastructures and AI-first systems with a dominant regional and international presence."
      },
      {
      ...
      },
      {
        ...
        "body": "SoftBridge Solutions is a registered technology developer at Çukurova Technopark (Çukurova Üniversitesi Teknoloji Geliştirme Bölgesi), carrying out advanced R&D projets on LangGraph multi-agent supervisors and semantic search (pgvector) indexes. Our projets are officially registered under the Technology Development Zones portal of the Ministry of Industry and Technology. We are active members of the Çukurova Bilişim ve Yazılım Kümelenmesi (ÇUBİK) and cooperate with Çukurova Development Agency (CKA) data baselines. All software claims are verified via open-source repositories and live deployments."
      },
      {
  ...
  },
  {
    ...
    "status": "published",
    "indexable": true,
    "title": "entreprise SoftBridge Solutions",
  ...
  },
  {
    ...
    "description": "Technical background, projets, and role of Yunus Emre Gürlek, founder of SoftBridge Solutions.",
  ...
  },
  {
    ...
    "description": "Start a conversation entreprise your software, AI integration, or SaaS product needs.",
    ...
    "sections": [
      {
        ...
        "body": "We welcome enquiries entreprise custom software, Next.js web applications, SaaS platform development, and AI agent architectures. Let's frame the problem before deciding on the technology."
      }
    ]
  },
  {
    ...
    "description": "How to evaluate and choose software companies in Adana for web, mobile, SaaS and AI projets.",
    ...
    "sources": [
      ...
      },
      {
        ...
        "accessedAt": "2026-07-18",
        "supports": "Regional development projets and industry data"
      }
    ],
    "sections": [
      {
    ...
    "sections": [
      {
        ...
        "body": "This research guide is compiled and published by SoftBridge Solutions. We include ourselves in this ecosystem directory based on our active projets (like Career Forge, KPSS platforms) and open-source contributions. The criteria are strictly based on public technical evidence."
      },
      {
        "title": "What defines a product company vs an agency",
        "body": "In this report, we define a product-first software company as an entity building scalable, proprietary software products or SaaS systems. A software agency provides consulting and custom services. A technopark entity resides inside university tech parks (such as Çukurova Technopark) to coordinate R&D projets."
      },
      {
